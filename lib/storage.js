...
export async function loadSettings() {
  ...
  s.search = { ...DEFAULT_SETTINGS.search, ...(saved.search || {}) };
  delete s.agent.debuggerDeclined; // resquício de quando 'debugger' era pedida em tempo de execução
  s.roles = {};
  for (const id of Object.keys(DEFAULT_ROLES)) s.roles[id] = { ...DEFAULT_ROLES[id], ...((saved.roles || {})[id] || {}) };
