...
export const OPTIONAL = ['audioCapture', 'history', 'downloads'];

export const LABELS = {
  audioCapture: 'Microfone (ditado por voz)',
...
export async function granted() {
  if (!API) return { debugger: true, audioCapture: true, history: true, downloads: true, unavailable: true };
