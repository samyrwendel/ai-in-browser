...
//
// A regra vale mesmo para conexões desativadas, de propósito. O botão "Testar
// conexão" sincroniza as regras e só então faz o POST de prova; se a regra
// dependesse de a conexão já estar ativa, testar um servidor local antes de
// ativá-lo daria 403 para sempre — e ativar depende justamente do teste passar.
// A regra é inócua: só afeta requisições que a própria extensão faz para
// aquela origem, e uma conexão desativada não faz nenhuma além do teste.
